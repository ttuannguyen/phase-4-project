...
s3 = SecretSpot.create(name: "Chinese Garden Tunnel", location: "Staten Island", description: "Beautiful garden!", cost: 13.99)
...
v3 = Visit.create(date: "12/2/2022", comment: "Exciting!", secret_spot: s2, user: u2)
v4 = Visit.create(date: "12/3/2022", comment: "Exciting!", secret_spot: s3, user: u3)
